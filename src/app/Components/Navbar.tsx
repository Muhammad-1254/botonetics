...
<div style={{left:`${offsetX+40}px`,backgroundColor:`${colors_array[colorIndex!-1]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`,}}
    ...
    >
      ...
      {/* for navbar Shadow  */}
      <div style={{left:`${offsetX-40}px`,backgroundColor:`${colorPalleteWise[colorIndex!+1]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0  rounded-l duration-200 opacity-25 shadow-lg '  />
<div style={{left:`${offsetX}px`,backgroundColor:`${colorPalleteWise[colorIndex]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0   duration-200 opacity-25 shadow-lg'  />
<div style={{left:`${offsetX+40}px`,backgroundColor:`${colorPalleteWise[colorIndex!-1]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`,}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0  rounded-r duration-200 opacity-25 shadow-lg'  />
    ...
    >
      ...
      {/* for navbar Shadow  */}
      <div style={{left:`${offsetX-40}px`,backgroundColor:`${randowColors[colorIndex!+1]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0  rounded-l duration-200 opacity-25 shadow-lg '  />
<div style={{left:`${offsetX}px`,backgroundColor:`${randowColors[colorIndex]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0   duration-200 opacity-25 shadow-lg'  />
<div style={{left:`${offsetX+40}px`,backgroundColor:`${randowColors[colorIndex!-1]}`,transitionDuration:`${offsetX == 0 ? "0s":"500ms"}`,}}
       className='  z-30 w-10  h-[60px] lg:h-[76px] my-auto  absolute top-0  rounded-r duration-200 opacity-25 shadow-lg'  />
